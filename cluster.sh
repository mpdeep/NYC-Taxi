...
start)  # start [<clusterName>]
  ...
  gcloud dataproc jobs submit hadoop --cluster bdawncluster1 --jar target/nyctaxi-mapreduce-0.0.1-SNAPSHOT-job.jar -- com.quackware.nyctaxi.mapreduce.fare.FareJob -- trips_copy
